...
class CategoryApiCall {
  Future<List<CategoryModel>> getAllCategories() async {
    ...
    const String url = "http://192.168.0.179:5000/categories/getAllCategories";
  ...
  Future<void> addCategory(CategoryModel category) async {
    try {
      const String url = "http://192.168.0.179:5000/categories/addCategory";
  ...
  Future<void> updateCategory(CategoryModel category, String id) async {
    try {
      String url =
          "http://192.168.0.179:5000/categories/updateCategoryName/${id}";
  ...
  Future<void> deleteCategory(String id) async {
    try {
      ...
      String url = "http://192.168.0.179:5000/categories/deleteCategory/${id}";
